...
Video.add({
	...
	platform: { type: Types.Select, required: true, initial:true, options: 'vimeo, youtube', default: 'other', index: true, note:"You must include https:// at the start of the url."},
